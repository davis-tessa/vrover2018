...
##When drive forward is chosen, continue for twice as long as the time spent driving to the left or right.
    ...
    LHB_options = [1, 1, 2, 2, 2, 2, 2, 2, 3, 3]
    RHB_options = [1, 1, 2, 2, 3, 3, 3, 3, 3, 3]
    ...
    if mode == 'left':
        ...
        print("explore            > 'mode' defined in function mode_discovery(drive_time, drive_burst, mode, check) must be 'left' or 'right' or 'party'. Please try again.")
